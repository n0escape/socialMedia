...
type actionTypes = followSuccessType | unfollowSuccessType | setUsersType | setCurrentUsersPageType 
| setTotalUsersCountType | setTotalUsersCountType | toggleIsFetchingType | toggleIsFollowingProcessType
